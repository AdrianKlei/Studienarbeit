...
"""autogenerated by genpy from fremenserver/FremenActionFeedback.msg. Do not edit."""
import sys
...
class FremenActionFeedback(genpy.Message):
  _md5sum = "82e97615735594b25e2cee3da22d3eb7"
  _type = "fremenserver/FremenActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fremenserver/FremenFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FremenActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = fremenserver.msg.FremenFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = fremenserver.msg.FremenFeedback()
